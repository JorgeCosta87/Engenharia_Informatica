...
net.layers{1}.transferFcn='logsig';  %para uma rede com 2 camadas escondidas, refere-se a camada escondida
net.layers{2}.transferFcn='logsig';  %para uma rede com 2 camadas escondidas, refere-se a camada escondida
net.layers{3}.transferFcn='purelin'; %para uma rede com 2 camadas escondidas, refere-se a saida
...
plotconfusion(irisTargets, out) % Matriz de confusao importante
...
r=0;
for i=1:size(out,2)               % Para cada classificacao   -sizeout(out,2) = igual ao numero de linhas do output
