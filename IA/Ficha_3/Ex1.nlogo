...
globals [food blue-nest yellow-nest]
...
to setup-patches
  ...
  [
    if random 101 < 5 [set pcolor red]      ;TRAPS
  ]
  ...
  set food 0
   ask patches with [pcolor = black]
  [
    if random 101 < 15 [set pcolor green set food food + 1]      ;TRAPS
  ]
...
to move-ants
  let x 0
    ...
    ask ants[
      if any? snails-on patch-ahead 1 and (nErva > 10) [
        ask one-of snails-on patch-ahead 1 [
          set x energia
          die
        ]
        set energia energia + x
        set nErva 0
      ]
       ...
       ifelse [pcolor] of patch-ahead 1 = red     ; TRAP AHEAD
        ...
        [ifelse [pcolor] of patch-ahead 1 = blue     ; NEST AHEAD
          ...
          [ifelse [pcolor] of patch-ahead 1 = green  and not(nErva >= capMax)   ; NEST AHEAD
            [fd 1
    ...
    ask snails[
      ...
      [ifelse [pcolor] of patch-left-and-ahead 90 1 = yellow ; NEST TO THE LEFT
       ...
       [ifelse [pcolor] of patch-right-and-ahead 90 1 = yellow ; NEST TO THE RIGHT
         ...
         [ifelse [pcolor] of patch-here = green ; NEST TO THE RIGHT
           [
              set energia energia + 50
              set pcolor  black
           ]
           ...
           [ifelse [pcolor] of patch-left-and-ahead 90 1 = red
             [fd 1 set energia energia - 1]
                      [ifelse [pcolor] of patch-right-and-ahead 90 1 = red
                        [fd 1 set energia energia - 1]
                        [ifelse random 100 < 90
                          [forward 1 set energia energia - 1]
                          [ifelse random 100 < 50 [rt 90 set energia energia - 1][lt 90 set energia energia - 1]
                          ]
                        ]
                      ]
                  ]
  ...
  ask turtles[
    ...
    [
      ...
      ask ants[
         ...
         if random 101 < reproductionFormigas [
           hatch 1 [jump 5]
       ...
       ask snails[
         ...
         if random 100 < reproductionCaracois [
