...
#ifdef FX1_EX8_DLL_EXPORTS 
#define DLL_IMP_API __declspec(dllexport)	//Directiva Que deve ser acrescentada antes de cada declaração
											// da funcao
#else
#define DLL_IMP_API __declspec(dllimport)	//se nao estiver na DLL
#endif
extern "C"
{
