...
//
	Ponto a(1,2), b(3,4);
////        Ponto a{1,2}, b{3,4}; outra fomra de inicializar
//	Ponto c;  // nao e possivel ter pontos sem especificar as suas coordenadas  a)
//
////	a.x=12; // erro : respeitar o conceito de encapsulamento: aceder a membros variaveis fora da classe
//	// deve ser impedido
//
//	cout << "\n A: " << a.getAsString() << "  B: " << b.getAsString()
//		 << " distancia: " << a.calculaDistancia(b) << endl;
////
	const Ponto c(5,6); // objecto const
//////
